...
public class PlayerController : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        rb2D
            ...
            movement * player.entity.speed * Time.fixedDeltaTime);
    }
    ...
    void Attack()
    {
        ...
        float distance =
            Vector2
                ...
                player.entity.target.transform.position);
        ...
        if (distance <= player.entity.attackDistance)
        {
            int dmg =
                player
                    .manager
                    .CalculateDamage(player.entity, player.entity.damage);
            int enemyDef =
                player
                    .manager
                    .CalculateDefense(monster.entity, monster.entity.defense);
